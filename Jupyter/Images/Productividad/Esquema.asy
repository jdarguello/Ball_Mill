...
x = x+3*fl/2;
//Primer círculo
draw((x,0){left} .. (x-0.4,a/5) .. (x,a), rgb(245/255, 92/255, 92/255));
draw((x,0){right} .. (x+0.4,a/5) .. (x,a), rgb(245/255, 92/255, 92/255));

draw((x,0) -- (x+3*a/2,0), rgb(245/255, 92/255, 92/255));
draw((x,a) -- (x+3*a/2,a), rgb(245/255, 92/255, 92/255));
label("Molienda", (x+(3*a/2)/2,a/2), rgb(245/255, 92/255, 92/255));
draw((x+(x-3*a/2)/3,a+fl) -- (x+(x-3*a/2)/3, a), arrow=Arrow, L=Label("Agente Dispersante", position=BeginPoint, align=N), rgb(245/255, 92/255, 92/255));
x = x+3*a/2;
draw((x,0){right} .. (x+0.4,a/5) .. (x,a), rgb(245/255, 92/255, 92/255));
